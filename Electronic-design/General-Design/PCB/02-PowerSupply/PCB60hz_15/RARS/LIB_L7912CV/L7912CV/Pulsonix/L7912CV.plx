...
//179537/1895263/2.50/3/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "L7912CV" (originalName "L7912CV")
	...
	(compDef "L7912CV" (originalName "L7912CV") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "L7912CV"))
		...
		(attr "Mouser Part Number" "511-L7912CV")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/L7912CV?qs=hprEbj%252BdINrTD2aXjPyteQ%3D%3D")
		(attr "Manufacturer_Name" "STMicroelectronics")
		(attr "Manufacturer_Part_Number" "L7912CV")
		(attr "Description" "L7912CV, Linear Voltage Regulator, Negative 1.5A -12 V, 3-Pin TO-220")
		(attr "<Hyperlink>" "https://www.st.com/resource/en/datasheet/l79.pdf")
		(attr "<Component Height>" "4.6")
		(attr "<STEP Filename>" "L7912CV.stp")
