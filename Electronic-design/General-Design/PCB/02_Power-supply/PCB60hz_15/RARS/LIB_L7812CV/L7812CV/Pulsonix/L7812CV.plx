...
//179446/1895263/2.50/3/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "L7812CV" (originalName "L7812CV")
	...
	(compDef "L7812CV" (originalName "L7812CV") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "L7812CV"))
		...
		(attr "Mouser Part Number" "511-L7812CV")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/L7812CV?qs=5Uvc6lfWVJzVGZQZmBynyg%3D%3D")
		(attr "Manufacturer_Name" "STMicroelectronics")
		(attr "Manufacturer_Part_Number" "L7812CV")
		(attr "Description" "TO220 voltage regulator,L7812CV 12V 1.5A STMicroelectronics L7812CV, Single Linear Voltage Regulator, 1.5A 12 V, 3-Pin TO-220")
		(attr "<Hyperlink>" "https://www.st.com/resource/en/datasheet/l78.pdf")
		(attr "<Component Height>" "4.6")
		(attr "<STEP Filename>" "L7812CV.stp")
